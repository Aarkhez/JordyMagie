...
export const SERVICES: Service[] = [
  {
    ...
    picture: BirthdayImg,
    shortDescription:
      "Faites de votre anniversaire un moment magique et inoubliable avec nos prestations captivantes et interactives.",
    longDescription:
  ...
  },
  {
    ...
    picture: BusinessImg,
    shortDescription:
      "Boostez la cohésion et l'ambiance au sein de votre équipe avec nos prestations de magie élégantes et immersives.",
    longDescription:
  ...
  },
  {
    ...
    picture: WeddingImg,
    shortDescription:
      "Transformez votre mariage avec nos prestations de magie distinguées et fascinantes, créant des moments de pur émerveillement.",
    longDescription:
  ...
  },
  {
    ...
    shortDescription:
      "Enchantez vos clients et créez une atmosphère unique dans votre restaurant avec nos prestations de magie close-up.",
    longDescription:
  ...
  },
  {
    ...
    picture: ContractImg,
    shortDescription:
      "Établissons ensemble un contrat sur mesure pour des prestations de magie régulières et inoubliables.",
    longDescription:
  ...
  },
  {
    ...
    picture: TeachImg,
    shortDescription:
      "Apprenez les secrets de la magie avec nos cours particuliers personnalisés, adaptés à tous les niveaux.",
    longDescription:
